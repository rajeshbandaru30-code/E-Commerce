          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input type="text" placeholder="Your Name" value={form.name}
              onChange={(e) => setForm({ ...form, name: e.target.value })} required
               className="w-full p-3 bg-white dark:bg-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-700 rounded-lg text-sm" />
            ...
            <textarea placeholder="Your Message" value={form.message} rows="5"
              onChange={(e) => setForm({ ...form, message: e.target.value })} required
               className="w-full p-3 border border-slate-200 dark:border-slate-700 rounded-lg text-sm resize-y" />
          ...
          <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-sm">
            ...
            <div className="space-y-3 text-sm">
              {[
                ...
                <details key={i} className="border border-slate-200 dark:border-slate-700 rounded-lg p-3">
