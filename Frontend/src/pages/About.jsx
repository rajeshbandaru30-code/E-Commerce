function About() {
  return (
    <div className="max-w-4xl mx-auto px-5 py-10">
      <h1 className="text-3xl font-bold mb-6">About ShopEZ</h1>
      <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-sm space-y-6">
        <section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={f.title} className="border border-slate-200 dark:border-slate-700 rounded-lg p-4">
        ...
        <section>
          ...
          <p className="text-slate-600 dark:text-slate-300">Have questions? Reach out to us at <a href="mailto:support@shopez.com" className="text-indigo-600 dark:text-indigo-400">support@shopez.com</a></p>
        </section>
      </div>
    </div>
  );
